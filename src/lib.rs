...
#[derive(Debug)]
pub struct QuillCompassProcessor {
    verbose: bool,
    processed_count: usize,
}

impl QuillCompassProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting QuillCompass processing");
    
    let mut processor = QuillCompassProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = QuillCompassProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = QuillCompassProcessor::new(false);
